...
declare const _default: import("vue").DefineComponent<{
    ...
    tabsList: import("vue").Ref<import("./types").TabComponent[]>;
    sliderHeight: import("vue").Ref<number | null>;
    sliderWidth: import("vue").Ref<number | null>;
    sliderOffsetX: import("vue").Ref<number>;
    sliderOffsetY: import("vue").Ref<number>;
    showPagination: import("vue").Ref<boolean>;
    tabsContentOffset: import("vue").Ref<number>;
    resizeObserver: import("vue").Ref<ResizeObserver | undefined>;
    startingXPoint: import("vue").Ref<number>;
    animationIncluded: import("vue").Ref<boolean>;
    ...
    tabSelected: import("vue").Ref<string | number | null>;
    ...
    updateSlider: (tab: import("./types").TabComponent) => void;
