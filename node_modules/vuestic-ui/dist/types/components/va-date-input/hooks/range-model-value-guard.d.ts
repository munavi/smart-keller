 ...
 */
export declare const useRangeModelValueGuard: (modelValue: Ref<VaDatePickerModelValue | undefined>, disabled: Ref<boolean>, parseValue?: (date: import("../types").VaDateInputModelValue) => VaDatePickerModelValue) => {
