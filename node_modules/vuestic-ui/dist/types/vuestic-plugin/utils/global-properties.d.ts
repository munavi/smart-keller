...
export declare const extractGlobalProperties: (app: App) => ComponentCustomProperties;
/**
...
export declare const getGlobalProperty: <Key extends keyof ComponentCustomProperties>(app: App, key: Key) => ComponentCustomProperties[Key];
