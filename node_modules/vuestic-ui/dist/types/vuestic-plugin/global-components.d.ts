...
declare type VuesticComponentsMap = Map<typeof vuesticComponents>;
/** Component names */
declare type VuesticComponentNames = keyof VuesticComponentsMap;
/**
 ...
 * */
export declare type VuesticComponents<NAMES extends string = VuesticComponentNames> = {
