 ...
 */
export declare const filterComponentProps: <ChildProps extends Record<string, unknown>, Props extends Record<keyof ChildProps, unknown>, Result extends ExtractPropTypes<ChildProps>>(propsValues: Props, childProps: ChildProps) => import("vue").ComputedRef<Result>;
