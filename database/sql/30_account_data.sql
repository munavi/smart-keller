...
INSERT INTO account("id", "name", "user","email" ,"password", "isAdmin")
VALUES
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11'::UUID,'Administrator', 'admin', 'admin@abc.de', 'changeit', true),
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12'::UUID, 'Redakteur',     'redak', 'redak@abc.de', 'changeit', false),
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13'::UUID, 'User', 'user', 'user@abc.de', 'abc123', true)
;
